...
if ( $op == "form" ) {
	...
	//$user_genre_text = new XoopsFormText("", "user_genre", 30, 60);
	//$user_genre_match = new XoopsFormSelectMatchOption("", "user_genre_match");
	//$user_genre_tray = new XoopsFormElementTray(_MM_GENRE, "&nbsp;");
	//$user_genre_tray->addElement($user_genre_match);
	//$user_genre_tray->addElement($user_genre_text);
	//$user_tonage_text = new XoopsFormText(_MM_TONAGE, "user_tonage", 30, 60);// nullos
	//$user_orientation_text = new XoopsFormText(_MM_ORIENTATION, "user_orientation", 30, 100);// nullos
	...
	//$user_codepostal_text = new XoopsFormText(_MM_CODEPOSTAL, "user_codepostal", 30, 40);// nullos
	//$user_regionfr_text = new XoopsFormText(_MM_REGIONFR, "user_regionfr", 30, 70);// nullos
	//$user_planete_text = new XoopsFormText(_MM_PLANETE, "user_planete", 30, 70);// nullos
	...
	$sort_select->addOptionArray(array("uname"=>_MM_UNAME,"user_from"=>_MM_LOCATION,"email"=>_MM_EMAIL,"last_login"=>_MM_LASTLOGIN,"user_regdate"=>_MM_REGDATE,"posts"=>_MM_POSTS));
	...
	//$form->addElement($user_tonage_text);
	//$form->addElement($user_orientation_text);
...
if ( $op == "submit" ) {
	...
	$validsort = array("uname", "user_genre", "user_tonage", "user_orientation", "user_from", "user_codepostal", "user_planete", "email", "last_login", "user_regdate", "posts");
	...
	if ( $total == 0 ) {
		...
		//$xoopsTpl->assign('lang_genre', _MM_GENRE);
		//$xoopsTpl->assign('lang_tonage', _MM_TONAGE);
		//$xoopsTpl->assign('lang_orientation', _MM_ORIENTATION);
		$xoopsTpl->assign('lang_from', _MM_LOCATION);
		//$xoopsTpl->assign('lang_codepostal', _MM_CODEPOSTAL);
		//$xoopsTpl->assign('lang_regionfr', _MM_REGIONFR);
		//$xoopsTpl->assign('lang_planete', _MM_PLANETE);
		...
		foreach (array_keys($foundusers) as $j) {
			...
			//$userdata['user_genre'] = $foundusers[$j]->getVar("user_genre");
			//$userdata['user_tonage'] = $foundusers[$j]->getVar("user_tonage");
			//$userdata['user_orientation'] = $foundusers[$j]->getVar("user_orientation");
			$userdata['user_from'] = $foundusers[$j]->getVar("user_from");
			//$userdata['user_codepostal'] = $foundusers[$j]->getVar("user_codepostal");
			//$userdata['user_regionfr'] = $foundusers[$j]->getVar("user_regionfr");
			//$userdata['user_planete'] = $foundusers[$j]->getVar("user_planete");
